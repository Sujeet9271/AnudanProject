    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_joined', models.DateField(default=datetime.datetime(2021, 6, 23, 16, 2, 54, 878292, tzinfo=utc), verbose_name='date joined')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('municipality', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Anudan.municipality', verbose_name='Municipality')),
            ],
            options={
                'verbose_name': 'Sector',
